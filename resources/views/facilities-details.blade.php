    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-md-9">
        <div class="text-justify">
          ...
          <h1 class="bottom-bar m-t-0">{{ $facilities_details->gal_name }}</h1>
          <p><?= $facilities_details->gal_desc ?></p>

          @if($facilities_gallery_images)
            <div class="row my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
              ...
              @foreach($facilities_gallery_images as $facilities_images)
                ...
                <figure class="col-sm-12 col-md-4 m-y-3" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject" >
                  ...
                  <figcaption itemprop="caption description" class="hidden">{{ $facilities_images->file_title }}</figcaption>
                </figure>
              @endforeach
