      ...
      <div class="col-sm-12 col-md-9">
        ...
        <div class="row m-b-6 p-b-4">
          ...
          <div class="col-xs-12 col-sm-8 col-md-9">
            ...
            <p class="admin-position lead text-muted text-uppercase m-t-0">Director</p>
            <h3 class="h4 bottom-bar">Background</h3>
            <p>Mr. Elpidio Balatbat finished college in the University of the East. He pursued his Masters in Business Administration in Ateneo de Manila University. He was the Vice President of the Administration in Ayala Life, Group of Companies before establishing Falcon Learning Center.</p>
          </div>
        </div>
